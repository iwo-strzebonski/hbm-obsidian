...
## Definicja
Równowaga (Equilibrium) to fundamentalna zasada magicznego świata HbM, określająca stabilność relacji między magią, Otchłanią i rzeczywistością. Jej naruszenie prowadzi do katastrof, manifestacji Personifikacji Otchłani lub powstania anomalii.

## Mechanizm działania
- Równowaga utrzymywana jest przez cykle magii, działania Personifikacji Otchłani i naturalne ograniczenia świata.
- Nadmiar magii, nadużycia rytuałów, masowe ofiary lub zakłócenia w strukturze rzeczywistości mogą ją zaburzyć.
- Skutki naruszenia: pojawienie się Otchłani, spaczenia, katastrofy magiczne, przebudzenie Personifikacji.
