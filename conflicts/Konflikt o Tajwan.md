...
| **Strony konfliktu** | **Chiny**, **krasnoludzkie klany** |
|---------------------|-----------------------------------------------|
| **Czas trwania**    | listopad 2025 |
| **Tło**             | Próba inwazji Chin na Tajwan, interwencja krasnoludzkich klanów ogłaszających wyspę strefą wolnego handlu pod swoją protekcją. |
| **Przebieg**        | Przygotowania do inwazji, ogłoszenie protektoratu krasnoludów, groźba blokady handlowej, wycofanie się Chin z operacji militarnej. |
| **Rezultat**        | Kompromis: Tajwan zachowuje niezależność, zobowiązuje się do "neutralności magicznej"; wzrost wpływów krasnoludów. |
...
## Wskazówki dla MG
> [!gm]+ Tylko dla MG
> Konflikt o Tajwan to idealne tło dla przygód szpiegowskich, cyberwojny i eksperymentów z magią w środowisku miejskim.
