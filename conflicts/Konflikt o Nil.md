...
| **Strony konfliktu** | **Egipt**, **koalicja państw afrykańskich**, elfowie z Hiondirs |
|---------------------|-----------------------------------------------|
| **Czas trwania**    | marzec–czerwiec 2024 |
| **Tło**             | Walka o kontrolę nad zasobami wodnymi i magicznymi Nilu, pojawienie się magicznych artefaktów. |
| **Przebieg**        | Interwencje Federacji, konflikty z lokalnymi magami, próby przejęcia artefaktów. |
| **Rezultat**        | Upadek egipskiego rządu, wzrost wpływów elfów w regionie, nowy ugodowy reżim w Kairze. |
...
## Wskazówki dla MG
> [!gm]+ Tylko dla MG
> Konflikt o Nil to doskonałe tło dla przygód związanych z eksploracją starożytnych artefaktów, polityką wodną i magią żywiołów.
