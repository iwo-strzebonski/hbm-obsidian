...
| **Zdjęcie**             | ![[bezimienny.jpg\|200]]                                                                               |
| ----------------------- | ------------------------------------------------------------------------------------------------------ |
| **Imię (imiona)**       | *Bezimienny*                                                                                           |
| **Nazwisko (nazwiska)** | *nieznane*                                                                                             |
| **Rasa**                | *[[Człowiek]] (pierwotnie); Duch / Głos*                                                          |
| **Wiek**                | *nieznany (starożytny)*                                                                               |
| **Wzrost**              | *zależy od awatara*                                                                                   |
| **Waga**                | *zależy od awatara*                                                                                   |
| **Dziedzina Magii**     | *[[Taumaturgia]], [[Botanika]]*                                                                        |
| **Organizacje**         | *<ul><li>[[Szkarłatny Kult]] (założyciel, pośrednio)</li><li>[[Królestwo Xivell]] (historycznie)</li></ul>* |
| **Pseudonim(y)**        | *Pierwszy Patriarcha*                                                                                  |
| **Tytuł(y)**            | *<ul><li>Pierwszy Patriarcha</li><li>Założyciel [[Taumaturgia\|Taumaturgi]] na [[Xivell (planeta)\|Xivell]]</li></ul>* |
| **Charakter**           | *nieznany*                                                                                             |
...
Bezimienny jest cichym graczem za kulisami. Postaci graczy mogą natknąć się na wzmianki o Pierwszym Patriarsze w archiwach [[Szkarłatny Kult|Szkarłatnego Kultu]], w akademickich tekstach o [[Taumaturgia|taumaturgi]] lub w rozmowach z członkami kultu, którzy czcą jego pamięć. Żaden z szeregowych członków kultu nie wie, że Patriarcha wciąż istnieje — ani kim jest jego awatar.

Jego cel pozostaje niejasny, lecz wszystkie poszlaki wskazują na to, że zamierza wykorzystać [[Federacja Sol-3|Federację Sol-3]] do realizacji planu związanego z oczyszczeniem [[Xivell (planeta)|Xivell]] — planety, którą sam niegdyś zniszczył.
