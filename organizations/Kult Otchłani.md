...
## Znani członkowie i byty
- [[Nil]] (Personifikacja Nicości)
...
Kult Otchłani jest w konflikcie z Inkwizycją i Szkarłatnym Kultem. Jego działania są nieprzewidywalne, a wpływ Otchłani może prowadzić do katastrof lub objawień. Praktyki kultu są zakazane w większości cywilizacji.

## Hooki dla MG
> [!gm]+ Tylko dla MG
> Zakon Otwartego Oka to źródło grozy, tajemnic i kontaktu z niepojętym. Rytuały, spaczenie i objawienia mogą być osią kampanii. Wielka Księga Obrzędów, Personifikacje i Posłańcy to kluczowe elementy fabularne. Używaj kultu do wprowadzania anomalii, nieprzewidywalnych efektów i filozoficznych dylematów.
>
